...
<script>
import { fetchDatasets, deleteDataset, FetchDatasetStatistics, FetchDatasetDetail, API_BASE } from "@/api";
import UploadZip from "../UploadZip/UploadZip.vue";
import defaultDatasetImg from "./images/image.png";
